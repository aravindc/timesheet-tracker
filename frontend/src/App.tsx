...
export default function TimesheetTracker() {
  ...
  const [authView] = useState<string>('login');
  ...
  const checkAuth = async () => {
    // Read token from URL fragment (OAuth callback redirect)
      ...
      <div className={`min-h-screen w-full flex items-center justify-center p-4 transition-colors ${
        ...
        <div className={`w-full max-w-md rounded-2xl shadow-xl p-8 transition-colors ${
          ...
          <div className="mb-6">
            ...
            <div className="mt-6">
              <div className={`flex items-center gap-3 my-4`}>
                <div className={`flex-1 h-px ${darkMode ? 'bg-gray-600' : 'bg-gray-200'}`} />
                <span className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>or continue with</span>
                <div className={`flex-1 h-px ${darkMode ? 'bg-gray-600' : 'bg-gray-200'}`} />
              </div>
              <div className="flex flex-col gap-2">
                <a
                  href="/api/auth/google/login"
                  className={`w-full flex items-center justify-center gap-2 border rounded-lg py-2 text-sm font-medium transition-colors ${
                    darkMode
                ...
                {/* <a
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#1877F2] hover:bg-[#166fe5] text-white rounded-lg py-2 text-sm font-medium transition-colors"
                >
          ...
          <p className={`text-center text-xs mt-4 ${darkMode ? 'text-gray-500' : 'text-gray-400'}`}>
            ...
            <a href="/terms.html" target="_blank" rel="noopener" className="underline hover:text-indigo-500">Terms of Service</a>
            {' '}and{' '}
            <a href="/privacy.html" target="_blank" rel="noopener" className="underline hover:text-indigo-500">Privacy Policy</a>
          </p>
        </div>
      </div>
    );
